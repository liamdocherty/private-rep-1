...
?>
				...
				<div class="template-content">
					...
					<!-- Section -->
					<div id="bazinga" class="template-section template-section-padding-1 template-clear-fix template-main">

						<!-- Header + subheader -->
						<div class="template-component-header-subheader">
							<h2>Who Is KC Details?</h2>
							<div></div>
						...
						<div class="template-layout-33x66 template-clear-fix">
							...
							<div class="template-layout-column-left">
								<img src="media/image/sample/460x678/image_01 copy.jpg" alt=""/>
							</div>
							...
							<div class="template-layout-column-right">
								...
								<!-- Text -->
								<p class="template-padding-reset text-justify">
								...
								<div class="template-component-feature-list template-component-feature-list-position-top template-clear-fix">
									...
									<ul class="template-layout-50x50 template-clear-fix">
										...
										<li class="template-layout-column-left template-margin-bottom-reset">
											...
											<h5 class="text-center">The Best Car Wash</h5>
										...
										<li class="template-layout-column-right template-margin-bottom-reset">
											...
											<h5 class="text-center">Contacting Us</h5>
											<ul class="template-component-list">
