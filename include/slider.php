		...
		<ul>
			...
			<li data-index="slide-1" data-transition="fade" data-slotamount="1" data-easein="default" data-easeout="default" data-masterspeed="500" data-rotate="0" data-delay="6000">
				...
				<div class="tp-caption tp-resizeme"
					...
					WELCOME TO KC DETAILS CAR DETAILING SERVICE
				</div>
				...
				<div class="tp-caption tp-resizeme"
					...
					<a class="template-component-button template-color-white smoothscroll" href="#bazinga" title="Purchase Template">Purchase Template</a>
				</div>
			</li>
